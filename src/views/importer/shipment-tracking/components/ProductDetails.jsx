    ...
    <Card mb={{ base: '0px', '2xl': '20px' }} {...rest}>
      ...
      <SimpleGrid columns={2} gap="20px">
        ...
        <Information
          boxShadow={cardShadow}
          title={
            title == 'Product Details' ? 'Total Value' : 'Transaction Amount'
          }
        ...
        <Information
          boxShadow={cardShadow}
          title={
            title == 'Product Details' ? 'Country of Origin' : 'Current Status'
          }
        ...
        <Information
          ...
          value={
            title == 'Product Details' ? valuePerItem : estimatedDeliveryDate
          }
        />
        <Information
          boxShadow={cardShadow}
